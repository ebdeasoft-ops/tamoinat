...
<div class="sidebar sidebar-left sidebar-animate">
	<div class="panel panel-primary card mb-0 box-shadow">
		...
		<a href="{{ url('/' . ($page = 'dashboard')) }}" title="dashboard" accesskey="d">
		</a>
		@can('Sales products')
		<a href="{{ url('/' . ($page = 'goToSale')) }}" title="goToSale" accesskey="s">
		</a>
		@endcan
		@can('sales return')
		<a href="{{ url('/' . ($page = 'return_sale')) }}" title="return_sale" accesskey="r">
		</a>
		@endcan
		@can('Purchases products')
		<a href="{{ url('/' . ($page = 'purchases')) }}" title="purchases" accesskey="p">
		</a>
		@endcan
		@can('purchase return')
		<a href="{{ url('/' . ($page = 'Purchase_returns')) }}" title='Purchase_returns' accesskey="u">
		</a>
		@endcan
		@can('purchase order to resources')
		<a href="{{ url('/' . ($page = 'Purchase_order_of_resources')) }}" title="Purchase_order_of_resources" accesskey="o">
		</a>
		@endcan
		@can('Add new product')
		<a href="{{ url('/' . ($page = 'addnewProduct')) }}" title="addnewProduct" accesskey="t">
		</a>
		@endcan
		@can('Add new supplier')
		<a href="{{ url('/' . ($page = 'addnewsupplier')) }}" title="addnewsupplier" accesskey="l">
		</a>
		@endcan
		@can('Add a new customer')
		<a href="{{ url('/' . ($page = 'addnewcustomer')) }}" title="addnewcustomer" accesskey="a">
		</a>
		@endcan
		@can('Product location changent')
		<a href="{{ url('/' . ($page = 'product_movement')) }}" title="product_movement" accesskey="y">
		</a>
		@endcan
		@can('Receipt')
		<a href="{{ url('/' . ($page = 'goToReceipt')) }}" title="goToReceipt" accesskey="g">
		</a>
		@endcan
		@can('offer price to customer')
		<a href="{{ url('/' . ($page = 'getproductspricetocustomer')) }}" title="getproductspricetocustomer" accesskey="c">
		</a>
		@endcan
		@can('Available quantity')

		<a href="{{ url('/' . ($page = 'getproductsquntitytocustomer')) }}" title="getproductsquntitytocustomer" accesskey="a">
		</a>
		@endcan

		@can('Produects')
		<a href="{{ url('/' . ($page = 'showAllProducts')) }}" title="showAllProducts" accesskey="t">
		</a>
		@endcan
		@can('Voucher')
		<a href="{{ url('/' . ($page = 'voncher')) }}" title="voncher" accesskey="i">
		</a>
		@endcan
		@can('Receipt document')
		<a href="{{ url('/' . ($page = 'reciept_decoument')) }}" title="reciept_decoument" accesskey="v">
		</a>
		@endcan

		@can('Cash expenses')
		<a href="{{ url('/' . ($page = 'cashEcprnse')) }}" title="cashEcprnse" accesskey="g">
		</a>
		@endcan
...
@endcan
			...
			<div class="list d-flex align-items-center border-bottom p-3">
				...
				<a class="wrapper w-100 mr-3" href="#">
					<p class="mb-0 d-flex ">
						<b>{{__('home.newinvoice')}}</b>
					</p>
					<div class="d-flex justify-content-between align-items-center">
						<div class="d-flex align-items-center">
							<i class="mdi las la-pen text-muted ml-1"></i>
							<small class="text-muted ml-auto">Ctrl + Y</small>
							<p class="mb-0"></p>
						</div>
					</div>
				</a>
			...
			<div class="list d-flex align-items-center border-bottom p-3">
				...
				<a class="wrapper w-100 mr-3" href="#">
					<p class="mb-0 d-flex ">
						<b>{{__('home.paymentchoose')}}</b>
					</p>
					<div class="d-flex justify-content-between align-items-center">
						<div class="d-flex align-items-center">
							<i class="mdi las la-pen text-muted ml-1"></i>
							<small class="text-muted ml-auto">Ctrl + Q</small>
							<p class="mb-0"></p>
						</div>
					</div>
				</a>
			...
			<div class="list d-flex align-items-center border-bottom p-3">
				...
				<a class="wrapper w-100 mr-3" href="#">
					<p class="mb-0 d-flex ">
						<b>{{__('home.savereciptsale')}}</b>
					</p>
					<div class="d-flex justify-content-between align-items-center">
						<div class="d-flex align-items-center">
							<i class="mdi las la-pen text-muted ml-1"></i>
							<small class="text-muted ml-auto">Ctrl + Z</small>
							<p class="mb-0"></p>
						</div>
					</div>
				</a>

...
<div class="main-parent">
    ...
    $count=App\Models\invoices::where('branchs_id',Auth()->user()->branchs_id)->where('save',1)->where('sent_to_zatca',0)->where('status',0)->orderby('id','desc')->count();
...
<script>
  ...
  $.ajax({
                url: " {{URL::to('getAllinvicesajax_send_zatca_not')}}",
                type: "GET",
                dataType: "html",

...
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{ __('home.Loans') }}</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card pt-4">
                <div class="card-body pt-3">
                    ...
                    <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2" action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'Loans')) }}" method="post">
                        {{ csrf_field() }}
                ...
                <div>
                    <div class="row ">
                        <div class="col-lg-4">
                            ...
                            <select name="employee_id" id="employee_id" class="form-control parent-input">
                        ...
                        <div class="col-lg-4" id="fnWrapper">
                            <label class="parent-label" id="increasValuelabel">{{ __('home.amountLoans') }} </label>
                            <input class="form-control parent-input mg-b-20" oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="Loans_amount" id="Loans_amount" required type="text" onkeyup="increasValueconvert()" value="0">
                        </div>

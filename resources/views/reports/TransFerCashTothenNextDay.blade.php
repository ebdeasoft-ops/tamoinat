...
@section('page-header')
    <div class="main-parent">
        ...
        <div class="breadcrumb-header justify-content-between parent-heading">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto"> {{ __('home.Transfer cash to the next day') }}</h4><span
            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    ...
                    <div style="border-radius: 10px !important" class="card-header pb-0">
                        ...
                        <form
                            action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'TransFerCashTothenNextDay')) }}"

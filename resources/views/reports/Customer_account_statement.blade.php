...
@section('title')
{{ __('home.Customer account_statement') }}
@endsection
...
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.Customer account_statement') }}
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'Customer_account_statement')) }}" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                ...
                <div style="border-radius: 10px" class="card m-3 p-3">
                    <div class="table-responsive">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            &nbsp;
                            &nbsp;
  <a style="background-color: #419BB2;font-size:15px;width: 120px!important;height:30px" href="{{ url('/' . ($page = 'generate_customer_statment_pdf') . '/' . $customer_id . '/' . $startat . '/' . $endat) }}"

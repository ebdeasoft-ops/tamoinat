...
@section('title')
{{ __('home.sales_product_by_date') }}@stop
@endsection
@section('page-header')
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.sales_product_by_date') }}
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'sales_product_by_date')) }}" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}

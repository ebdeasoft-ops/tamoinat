...
@section('title')
    {{ __('home.transactionsToMasterBranch') }}@stop
@endsection
@section('page-header')
    <div class="main-parent">
        ...
        <div class="breadcrumb-header justify-content-between parent-heading">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">{{ __('home.transactionsToMasterBranch') }}</h4><span
            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    ...
                    <div style="border-radius: 10px !important" class="card-header pb-0">
                        ...
                        <form
                            action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'searchtransactionsToMasterBranch')) }}"
                            ...
                            <div class="row ">
                                ...
                                <div class="col" id="type">
                                    <p class="mg-b-10 parent-label"> {{ __('home.branch_sender') }} </p>

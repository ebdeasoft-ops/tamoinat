...
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.sel_product_withoud_tax') }}
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'salesReport_delivery')) }}" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                ...
                <div style="border-radius: 10px" class="card-body mt-5">
                    <div class="table-striped">
                        ...
                        <table class="table table-hover table-bordered" id="example1" data-page-length='50' style=" text-align: center; width:95%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="<?php echo $product['id']; ?>">
                                            ...
                                            <td> <a style="color: #23395D" class="dropdown-item" href="showInvoiceRecentdelivery/{{ $product->id }}"><i style="fill:#072c3c !important" class=" fas fa-print"></i>&nbsp;&nbsp;
                                                    {{ __('home.show') }}
                                                </a></td>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1" href="">
                                {{ __('home.print') }}

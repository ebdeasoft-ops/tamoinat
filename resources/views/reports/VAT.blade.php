            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    ...
                    <div class="card-header pb-0">
                        ...
                        <form
                            action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'VAT')) }}"
                    ...
                    <div style="border-radius: 10px" class="card m-3 p-3">
                        <div class="table-responsive">
                                    <div class="table-responsive hoverable-table table-padding">
                                        <table class="table table-bordered table-striped table-hover" id="example1" data-page-length='50'
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0"> {{ __('home.expensesVAT') }}</th>
                                        ...
                                        <div class="d-flex justify-content-center my-3">
                                            ...
                                            <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1"
                                                href="{{ url('/' . ($page = 'print_VAT') . '/' . $branch_id . '/' . $data['start_at'] . '/' . $data['end_at']) }}">
                                                {{ __('home.print') }}

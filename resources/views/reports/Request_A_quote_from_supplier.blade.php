            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    ...
                    <div class="card-header pb-0">
                        ...
                        <form
                            action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'Requestـaـquoteـfromـtheـsupplier')) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col" id="type">
                                    ...
                                    <select class="form-control parent-input" name="branch" required>
                                        <option style="font-size: 15px" value="-" selected>{{ __('users.allbranchs') }}
                                        </option>
...
{{-- 
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    ...
                                    <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1"
                                        href="{{ url('/' . ($page = 'print_Requestـaـquoteـfromـtheـsupplier') . '/' . $supplierId[1] . '/' . $supplierId[0] . '/' . $startat . '/' . $endat) }}">
                                        {{ __('home.print') }}

            ...
            <div class="card mg-b-2">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive hoverable-table">
                        ...
                        <div class="hoverable-table table-padding mt-5">
                            <table class="table table-hover table-striped table-bordered" id="example1" data-page-length='50' style=" text-align: center;">

...
<div class="breadcrumb-header justify-content-between no-print">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{ __('home.cashFlowStatement') }}</h4>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="card card-custom mg-b-20 no-print">
    <div class="card-body">
        <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ('cashFlowStatement')) }}" method="POST" role="search" autocomplete="off">
            {{ csrf_field() }}
...
<div id="print">
    <div class="card card-custom">
        <div class="card-body">
            <!-- يمكنك إضافة محتوى أو جدول التقرير هنا لاحقاً -->
            <div class="text-center py-4">
                <h4 class="font-weight-bold">{{ __('home.cashFlowStatement') }}</h4>

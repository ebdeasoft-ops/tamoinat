...
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.cost_center') }}
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'cost_center_search')) }}" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                             ...
                             <div class="col-lg-3" id="start_at">
                                ...
                                <div class="col-lg-3" id="end_at">
                                <p class="mg-b-10 parent-label"> {{ __('home.cost_center') }} </p>
                                  <select style="width:100%" class="form-control select2" name="cost_center" id="cost_center" class="form-control select2">
                     <option value='-'> -</option>

                        @foreach ( App\Models\Cost_centers::get() as $info )
                        <option value="{{$info->id}}"> {{App::getLocale()=='ar'?$info->cost_center_ar:$info->cost_center_en}}</option>
                        @endforeach
                     </select>
                ...
                <div style="border-radius: 10px" class="card-body mt-5">
                    <div class="table-striped">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1" href="{{ url('/' . ($page = 'printInvoicesReport') . '/' . $pay[1] . '/' . $pay[0] . '/' . $startat . '/' . $endat) }}">
                                {{ __('home.print') }}
                            ...
                            &nbsp;
                             <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1" href="{{ url('/' . ($page = 'printInvoicesReportdetails') . '/' . $pay[1] . '/' . $pay[0] . '/' . $startat . '/' . $endat) }}">

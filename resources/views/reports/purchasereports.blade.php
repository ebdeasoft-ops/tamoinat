                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3" id="start_at">
                                ...
                                <div class="input-group">
                                    ...
                                    </div><input class="parent-input form-control fc-datepicker" value="{{ $start_at ?? '' }}" name="start_at" placeholder="YYYY-MM-DD" type="text" required>
                                </div><!-- input-group -->
                            </div>
                            ...
                            <div class="col-lg-3" id="end_at">
                                ...
                                <div class="input-group">
                                    ...
                                    </div><input class="parent-input form-control fc-datepicker" name="end_at" value="{{ $end_at ?? '' }}" placeholder="YYYY-MM-DD" type="text" required>
                                </div><!-- input-group -->
                            </div>
                            ...
                            <div class="col-lg-6" id="type">
                                ...
                                <select class="parent-input form-control select2" name="productname" required>
                                    ...
                                    <option value="{{ $section->id }}"> <label dir=ltr>{{ $section->barcode }}</label> :
                                        {{ $section->name }}
                                    </option>
                                    @endforeach
                                </select>
                ...
                <div style="border-radius: 10px" class="card m-3 p-3">
                    <div class="table-responsive hoverable-table">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1" href="{{ url('/' . ($page = 'print_purchasereports') . '/' . $supplierId . '/' . $startat . '/' . $endat) }}">
                                {{ __('home.print') }}

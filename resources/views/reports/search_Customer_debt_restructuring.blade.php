...
@section('title')
{{ __('home.Customer_debt_restructuring') }}@stop
@endsection
@section('page-header')
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.Customer_debt_restructuring') }}
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'Customer_debt_restructuring')) }}" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                     ...
                     <option value='-'> -</option>
                        ...
                        @foreach ( App\Models\financial_accounts::where('orginal_type',1)->get() as $info )

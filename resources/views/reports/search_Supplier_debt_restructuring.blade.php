...
@section('title')
{{ __('home.Supplier_debt_restructuring') }}@stop
@endsection
@section('page-header')
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.Supplier_debt_restructuring') }}
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'Supplier_debt_restructuring')) }}" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col" id="type">
                                <p class="mg-b-10 parent-label"> {{ __('home.saerch_by_numberaccount_or_name') }} </p>
                                  <select style="width:25%" class="form-control select2" name="parent_account_number" id="parent_account_number" class="form-control select2">
                     <option value='-'> -</option>

                        @foreach ( App\Models\financial_accounts::where('orginal_type',2)->get() as $info )

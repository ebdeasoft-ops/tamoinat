...
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.sales_and_return') }}
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'sales_and_return')) }}" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 parent-label" id="end_at">

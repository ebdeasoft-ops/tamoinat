...
@section('title')
{{ __('home.Cash_withdrawal_from_the_bank') }}@stop
@endsection
@section('page-header')
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading parent-label">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.Cash_withdrawal_from_the_bank') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">
                </span>
            </div>
        </div>
    </div>
...
<form action="{{ '/' . ($page = 'printwithdrawal_from_the_bank') }}" method="POST" role="search" autocomplete="off">
    {{ csrf_field() }}
...
<script>
     $("#button_1").click(function(e) {
        var url = " {{ URL::to('Cash_withdrawal_from_the_bank') }}";

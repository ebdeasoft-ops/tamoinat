...
<div class="card">
   ...
   <div class="card-body">
      ...
      <form autocomplete="off" action="{{ route('admin.itemcard.store') }}" method="post" enctype="multipart/form-data">
         <div class="row">
            @csrf
            <div class="col-md-6">
               <div class="form-group">
                  <label> {{__('home.barcodeifnotfount')}}</label> <span id="barcodeCheckMessage"> </span>
                  <input autocomplete="off" name="barcode" id="barcode" onkeyup="barcodeConvert()" autofocus class="form-control" value="{{ old('barcode') }}" placeholder="{{__('home.barcode')}}">
                  @error('barcode')
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input autocomplete="off" name="name" id="name" class="form-control" value="{{ old('name') }}">
                  @error('name')
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
               </div>
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <select name="inv_itemcard_categories_id" id="inv_itemcard_categories_id" class="form-control select2">
                     <!-- <option value="0"> {{__('home.chooseOne')}}</option> -->
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <select name="parent_inv_itemcard_id"
        id="parent_inv_itemcard_id"
        class="form-control"
        style="width:100%">
                                           <option  value="0"> {{__('home.isparent')}}</option>
            ...
            <div class="col-lg-6  " @if(old('does_has_retailunit')!=1 ) style="display: none;" @endif id="retail_uom_idDiv">
               <div class="form-group">
                  <label> {{__('home.Retail unit of measure')}} (<span class="parentuomname"></span>)</label>
                  <br>
                  <select style="width:100%" name="retail_uom_id" id="retail_uom_id" class="form-control select2">
            ...
            <div class="col-md-6 relatied_retial_counter " @if(old('retail_uom_id')=="" ) style="display: none;" @endif>
               <div class="form-group">
                  ...
                  <input  autocomplete="off" oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="retail_uom_quntToParent" id="retail_uom_quntToParent" class="form-control" value="{{ old('retail_uom_quntToParent') }}" placeholder="ادخل  عدد وحدات التجزئة">
            ...
            <div class="col-md-6">
               <div class="form-group">
                  <select hidden name="active" id="active" class="form-control">
...
$(document).ready(function () {
    ...
    $('#parent_inv_itemcard_id').select2({

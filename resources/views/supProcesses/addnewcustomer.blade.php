                        ...
                        <form
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control parent-input" id="timeout_periodـinـdays"
                                        name="timeout_periodـinـdays"
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control parent-input" id="credit_limit" name="credit_limit"
                                        onkeyup="credit_limitConvert()" title="{{ __('supprocesses.credit_limit') }}"
                                        required>
                                </div>

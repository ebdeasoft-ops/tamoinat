    ...
    @section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                ...
                @if (session()->has('create_reason_expense'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <br>

                        <strong>{{ session()->get('create_reason_expense') }}</strong>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                ...
                <div style="border-end-end-radius: 10px;border-end-start-radius:10px" class="card pt-5">
                    <div class="card-body">
                        ...
                        <form
                            action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'expenses_reason')) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <label for="inputName" class="control-label parent-label">{{ __('report.enpenses_reason') }}</label>
                                ...
                                <label for="inputName"
                                    class="control-label parent-label">{{ __('home.expensesHaveavt') }}</label>
                                <select name="AVT" class="form-control parent-input" >
                                    <!--placeholder-->

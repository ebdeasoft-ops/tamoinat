...
<div class="main-parent">
                    ...
                    <div class="my-auto">
                        ...
                        <div class=" d-flex justify-content-between">
                            <div class="choose-product m-1 mt-3">
                                <button style="background-color: #FBA10F;font-size:16px;width:162px" class="modal-effect btn btn-sm btn-info p-1" data-effect="effect-scale" data-toggle="modal" href="#SearchProduct" title="تحديد">
                                    {{ __('home.chooose product') }}
                                    <i style=" height: 100;
                         
                         font-size:15px" class="las"></i>
                        ...
                        <div>
                            <div class='row'>
                                ...
                                <div class="col mg-t-20 mg-lg-t-0">
                                    ...
                                    <input type="text" hidden=true class="form-control" id="totalvalueinvoice" name="totalvalueinvoice" value=0>
                            ...
                            <input hidden=true class="form-control" id="branchs_id" name="branchs_id" value="-">
                    ...
                    <div style="border-radius: 10px" class="card px-3 pt-4">
                        ...
                        <div style="padding-bottom: 0" class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-4 mg-t-20 mg-lg-t-0">
                                    <label for="recipient-name" class="form-label parent-label"> {{ __('home.Invoice_no') }}
                                    </label>
                                    <input style="height: 30px;outline :none" for="inputName" class="col-lg-3 mg-lg-t-0 parent-input" id="showInvoiceNumber" name="showInvoiceNumber" title="{{ __('home.Invoice_no') }}" readonly>
                            ...
                            <div class="table-responsive mg-t-30">
                                ...
                                <br>
                                <div class="d-flex justify-content-center">
                                    <button style="background-color: #419BB2" id="saveInvoice" name="saveInvoice" class="btn btn-success p-1">
                                ...
                                <div class="row  d-flex justify-content-end mt-3">
                                    ...
                                    <form action="{{ '/' . ($page = 'returnAll') }}" method="POST" role="search" autocomplete="off">
                                        ...
                                        <div class="col " id="returnAlldiv">
                                            <input type="number" class="form-control " name="invoice_no_delete_All" id="invoice_no_delete_All" title=" رقم الفاتورة " readonly required=true hidden>
                                            <input class="form-control " name="pagename" id="pagename" readonly value="products.sales" hidden>
 ...
 <center><img style="width:250px;height:250px;" class="custom_img" src="{{ asset('assets/admin/uploads/done.png') }}" >
        ...
        <div class="modal fade product-selection" id="SearchProduct" name="SearchProduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" dir='rtl' aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'updatePurchase')) }}" method="post" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="inputName" class="control-label parent-label"> {{ __('home.avt') }} </label>
                                    <input type="number" class="form-control parent-input" id="avt_update" name="avt_update" title="يرجي ادخال الكمية  " value="{{ $avtSaleRate }}" readonly>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="inputName" class="control-label parent-label"> {{ __('home.discount') }}</label>
                                    <input type="number" class="form-control parent-input" id="product_price_after_dis_update" value=0 name="product_price_after_dis_update">
                                </div>
    ...
    <script>
        function changeAvtValue(avt) {
            ...
            $('#priceWithTax').val(((Math.round((price * avt) * 1000) / 1000) + price * 1).toFixed(2));
    ...
    <script>
        function changeAvtValuempdale(avt) {
            ...
            $('#avt_update').val((Math.round((price * avt) * 1000) / 1000).toFixed(2));
            $('#priceWithTax_update').val(((Math.round((price * avt) * 1000) / 1000) + price * 1).toFixed(2));
    ...
    <script>
        function changePriceWithTax() {
            ...
            $('#avt').val((Math.round(((price - rountavt) * 100), 2) / 100).toFixed(2));
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data && data['discount'] != 0) {
                            ...
                            c4.innerText = totaldiscountvalue.toFixed(1);

                            document.getElementById('totalvalue').innerHTML = totaldiscountvalue.toFixed(1);

                            $('#totalvalueinvoice').val(totaldiscountvalue.toFixed(1))
                            if ($('#pay').val() == "Cash") {
                                $('#cashamount').val(totaldiscountvalue.toFixed(1))
                            } else if (('#pay').val() == "Shabka") {
                                $('#bankamount').val(totaldiscountvalue.toFixed(1))

                            } else {
                                $('#creaditamount').val(totaldiscountvalue.toFixed(1))

...
" dir='rtl'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                           ...
                                           <td style="font-size:12px;text-align: right;">{{ $product->productData->product_name}}</td>
                                        <td style="font-size:13px;text-align: center;">{{ $product->Unit_Price}}</td>
                                        <td style="font-size:13px;text-align: center;">{{ $product->quantity}}</td>
                                        <td style="font-size:13px;text-align: center;">{{round( ($product->Unit_Price*$product->quantity), 2)}}</td>
